        ...
        <md-table>
            ...
            <transition-group name="bounceRight" appear tag="tbody" class="md-table-body dico-body"> 
                <md-table-row v-for="(dico, i) in currentDico" :style="$animationDelay(i)" :key="i" >
                    <md-table-cell class="animated-cell">{{dico.req}}</md-table-cell>
                    <md-table-cell class="animated-cell">{{dico.res}}</md-table-cell>
                    <md-table-cell class="animated-cell">
                        <p class="dico-uuid" :class="{show: showID}">{{dico.uuid}}0</p>
                    </md-table-cell>
                </md-table-row>
            </transition-group>
